...
class Beneficiaries {
    ...
    updateBeneficiaries() {
        ...
        for (let i = 0; i < this.accounts.length; i++) {
            ...
            beneficiaryListHtml += '<td><a class="styledButton styledButtonSmall beneficiaryDelBtn' + this.getNetwork() + '" id="beneficiaryDelBtn'+this.getNetwork()+'_'+this.accounts[i].account+'">Remove</a></td>'
            beneficiaryListHtml += '</tr>'
        }
