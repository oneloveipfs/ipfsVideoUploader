...
ipcMain.on('spk_update_info', async (evt,arg) => evt.sender.send('spk_update_info_result', await spk.updateInfo(arg.cookie,arg.id,arg.title,arg.desc,arg.tags,arg.nsfw,arg.lang,arg.powerup,arg.community)))
